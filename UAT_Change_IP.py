...
logging.basicConfig(filename=r'D:\Dropbox\logs\uat_change_ip.log', level=logging.INFO, filemode="a",
...
conn = pymssql.connect(server=UAT_DB.host, user=UAT_DB.user,
                       password=UAT_DB.password, database=UAT_DB.database)
cursor = conn.cursor()
