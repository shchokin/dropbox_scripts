...
result = cursor.fetchone()
print(colored("%d == %s ==" % (result[0], result[1]), "green"))
...
while isCorrectLocationId == 0:
    ...
    if not location:
        ...
        try:
            ...
            print(colored("\n\t\t\t*** Location Id is not correct. Try again. ***", "red"))
            sys.stderr.write(colored(str(x), "red"))
...
while isCorrectUserGroupId == 0:
    ...
    if not user_group:
        ...
        try:
            ...
            print(colored("\n\t\t\t*** User Group Id is not correct. Try again. ***", "red"))
            sys.stderr.write(colored(str(x), "red"))
